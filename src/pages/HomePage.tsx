        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              `}
            >
              <span className="w-2 h-2 rounded-full bg-[#C9A66B] animate-pulse shrink-0" />
              <span>
        ...
        className={`
          ...
          ${
            theme === "dark"
              ...
              : "border-black/[0.08] bg-white/80 hover:border-[#9A743B]/30 hover:bg-[#9A743B]/[0.04]"
          }
        `}
      >
        <Icon
          ...
          className={`
            ...
            ${
              theme === "dark"
                ...
                : "text-[#65615A] group-hover:text-[#171717]"
            }
          `}
        >
          {tech.name}
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        <div
          className={`
            ...
            ${
              theme === "dark"
                ? "bg-gradient-to-b from-[#0A0A0A] via-[#0A0A0A] to-[#0A0A0A]"
                : "bg-gradient-to-b from-[#F5F4EF] via-[#F5F4EF] to-[#F1EFE9]"
            }
          `}
        />
      ...
      <div className="relative z-10 mx-auto mb-14 max-w-4xl px-4 text-center">
        ...
        >
          ...
          <p
            ...
            `}
          >
            The technologies I use to build scalable, secure,
      ...
      >
        <div
          className={`
            relative overflow-hidden rounded-3xl border p-4 sm:p-6 lg:p-8
            ${
              theme === "dark"
                ? "border-white/[0.08] bg-white/[0.025] shadow-[0_20px_60px_rgba(0,0,0,0.22)]"
                : "border-black/[0.08] bg-white/80 shadow-[0_20px_60px_rgba(30,25,15,0.07)]"
            }
          `}
        >
          <div className="pointer-events-none absolute left-1/2 top-1/2 h-80 w-80 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#C9A66B]/[0.045] blur-[120px]" />
          <div className="pointer-events-none absolute left-1/2 top-0 h-px w-2/3 -translate-x-1/2 bg-gradient-to-r from-transparent via-[#C9A66B]/30 to-transparent" />

          <div className="relative z-10 space-y-3 sm:space-y-4">
            <MarqueeRow items={firstRow} duration={26} />
            <MarqueeRow items={secondRow} reverse duration={30} />
            <MarqueeRow items={thirdRow} duration={27} />
          </div>

          <div
            className={`
              pointer-events-none absolute inset-y-0 left-0 z-20 w-12 sm:w-20 bg-gradient-to-r
              ${
                theme === "dark"
                  ? "from-[#0A0A0A] via-[#0A0A0A]/90 to-transparent"
                  : "from-[#F5F4EF] via-[#F5F4EF]/90 to-transparent"
              }
            `}
          />
          <div
            className={`
              pointer-events-none absolute inset-y-0 right-0 z-20 w-12 sm:w-20 bg-gradient-to-l
              ${
                theme === "dark"
                  ? "from-[#0A0A0A] via-[#0A0A0A]/90 to-transparent"
                  : "from-[#F5F4EF] via-[#F5F4EF]/90 to-transparent"
            ...
            `}
          />
          <div className="pointer-events-none absolute bottom-0 left-1/2 h-px w-2/3 -translate-x-1/2 bg-gradient-to-r from-transparent via-[#C9A66B]/20 to-transparent" />
        </div>
      </motion.div>
    </section>
  );
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-[30%] h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-[#C9A66B]/[0.025] blur-[150px]" />
        <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#C9A66B]/20 to-transparent" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="mb-5 flex items-center gap-4">
            ...
            <span className="text-xs font-semibold uppercase tracking-[0.35em] text-[#C9A66B]">
              Selected Work
            </span>
          </div>

          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <h2 className="text-5xl font-bold leading-[0.95] tracking-tight sm:text-6xl lg:text-7xl">
              <span
                className={
                  theme === "dark"
                    ? "text-[#F5F3EE]"
              ...
              <br />
              <span className="text-[#C9A66B]">Showcase</span>
            </h2>
            <p
              className={`
                max-w-md text-base leading-7 lg:pb-1
                ${
                  theme === "dark"
                    ? "text-[#8F8B83]"
                    : "text-[#65615A]"
            ...
            return (
              ...
              >
                <div className="mb-6 flex items-center gap-4">
                  <span className="font-mono text-sm font-medium tracking-[0.2em] text-[#C9A66B]">
                    {projectNumber}
                  </span>
                  <div
                ...
                <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                  <div>
                    <h3
                      className={`
                        text-3xl font-bold tracking-tight transition-colors duration-300 sm:text-4xl lg:text-5xl
                        ${
                          theme === "dark"
                    ...
                    <p className="mt-2 text-sm uppercase tracking-[0.18em] text-[#C9A66B]">
                      {project.technologies.slice(0, 3).join(" · ")}
                    </p>
                  </div>
                  <div
                    className={`
                      hidden h-12 w-12 items-center justify-center rounded-full border text-xl transition-all duration-300 lg:flex
                      ${
                        theme === "dark"
                          ? "border-white/10 bg-white/[0.025] text-[#C9A66B] group-hover:border-[#C9A66B]/30 group-hover:bg-[#C9A66B]/[0.05]"
                          : "border-black/10 bg-white text-[#9A743B] group-hover:border-[#9A743B]/30 group-hover:bg-[#9A743B]/[0.04]"
                      }
                    `}
                  >
                    {project.icon}
                ...
                <div
                  ...
                  `}
                >
                  <div className="absolute left-1/2 top-0 z-20 h-px w-1/3 -translate-x-1/2 bg-gradient-to-r from-transparent via-[#C9A66B]/60 to-transparent" />
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.7, ease: "easeOut" }}
                    className="relative aspect-[16/8] overflow-hidden sm:aspect-[16/7]"
                  >
                    <img
                      ...
                      onError={(e) => {
                        ...
                        target.src = `data:image/svg+xml,${encodeURIComponent(
                          `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="600"><rect width="100%" height="100%" fill="#111111"/><text x="50%" y="50%" fill="#C9A66B" font-family="sans-serif" font-size="42" text-anchor="middle" dominant-baseline="middle">${project.title}</text></svg>`
                        )}`;
                      }}
                    />
                    <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/60 via-black/10 to-transparent" />
                    <div className="absolute bottom-5 left-5 flex h-12 w-12 items-center justify-center rounded-xl border border-white/15 bg-black/40 text-xl text-[#D8BC91] backdrop-blur-md sm:bottom-7 sm:left-7">
                      {project.icon}
                    </div>
                    {isLive && (
                      <a
                        ...
                        className="absolute right-5 top-5 inline-flex h-11 items-center gap-2 rounded-full border border-white/15 bg-black/40 px-5 text-xs font-semibold text-white opacity-0 backdrop-blur-md transition-all duration-300 group-hover:opacity-100 hover:border-[#C9A66B]/50 hover:bg-black/60 sm:right-7 sm:top-7"
                      >
                ...
                <div className="mt-7 grid grid-cols-1 gap-8 lg:grid-cols-12">
                  ...
                  <div className="lg:col-span-5">
                    <div className="mb-3 text-[10px] font-semibold uppercase tracking-[0.25em] text-[#C9A66B]">
                      Built With
                    </div>
                      ...
                      {project.technologies.map((tech) => (
                        <span
                          ...
                          className={`
                            ...
                            ${
                              theme === "dark"
                                ? "border-white/10 bg-white/[0.025] text-white/60 group-hover:border-[#C9A66B]/20 group-hover:text-[#D8BC91]"
                                : "border-black/10 bg-black/[0.015] text-[#65615A] group-hover:border-[#9A743B]/20 group-hover:text-[#7C5B2B]"
                            }
                          `}
                        >
                          {tech}
                ...
                <div className="mt-8 flex flex-wrap items-center gap-6">
                  {isLive && (
                    ...
                    >
                      ...
                      <FaArrowRight
                        className="text-xs transition-transform duration-200 group-hover/link:translate-x-1"
                        aria-hidden="true"
                      />
                    </motion.a>
                  )}
                ...
                {index < PROJECTS.length - 1 && (
                  <div className="mt-16 h-px bg-gradient-to-r from-[#C9A66B]/20 via-white/[0.06] to-transparent" />
                )}
              </motion.article>
            );
          })}
          ...
          {cards.map((card, index) => {
            ...
            return (
              ...
              >
                  ...
                  className={`
                    ...
                    ${
                      card.accent === "primary"
                        ...
                        : "from-[#C9A66B]/[0.08] to-transparent"
                    }
                  `}
                />
                ...
                <div className="absolute bottom-0 left-0 right-0 h-0.5 rounded-b-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r from-[#C9A66B] to-transparent" />
              </motion.div>
            );
          })}
        </motion.div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-14">
          ...
          <motion.p
            ...
            animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{ delay: 0.2 }}
            className={`text-lg mt-4 max-w-xl mx-auto ${t(
              theme,
              "text-gray-400",
              "text-gray-600"
            )}`}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-stretch">
          <motion.div
            initial={
              prefersReducedMotion ? false : { opacity: 0, x: -30 }
            }
            animate={inView ? { opacity: 1, x: 0 } : {}}
            transition={{ delay: 0.2 }}
          ...
          >
            <div
              className={`rounded-2xl p-6 border flex-1 ${t(
                theme,
            ...
            >
              <h3
                className={`text-xl font-bold mb-4 ${t(
                  theme,
                  "text-white",
                  "text-gray-900"
                )}`}
                ...
                {[
                  ...
                  href ? (
                    <a
                      key={label}
                      href={href}
                      className={`flex items-start gap-3 transition-colors rounded ${t(
                        theme,
                    ...
                    >
                      <div
                        className={`mt-0.5 p-2 rounded-lg ${t(
                          theme,
                          "bg-[#C9A66B]/[0.06]",
                          "bg-[#9A743B]/[0.05]"
                        )}`}
                    ...
                    <div
                      key={label}
                      className={`flex items-start gap-3 ${t(
                        theme,
                        "text-gray-400",
                        "text-gray-600"
                      )}`}
            ...
            >
              <h3
                className={`text-lg font-bold mb-4 ${t(
                  theme,
                  "text-white",
                  "text-gray-900"
                )}`}
          ...
          >
            <div
              className={`rounded-2xl p-8 border h-full ${t(
                theme,
                "bg-white/[0.025] border-white/10",
                "bg-white border-black/10 shadow-sm"
              )}`}
                ...
                {status === "sent" ? (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="mt-4 text-sm text-[#C9A66B] hover:text-[#D8BC91] underline underline-offset-4 rounded"
                    >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label
                          ...
                          className={`block text-xs font-medium mb-1.5 ${t(
                            theme,
                            "text-gray-400",
                            "text-gray-600"
                          )}`}
                    ...
                    <div className="flex flex-1 flex-col">
                      <div className="flex items-center justify-between mb-1.5">
                        <label
                          ...
                          className={`block text-xs font-medium ${t(
                            theme,
                            "text-gray-400",
                            "text-gray-600"
                          )}`}
